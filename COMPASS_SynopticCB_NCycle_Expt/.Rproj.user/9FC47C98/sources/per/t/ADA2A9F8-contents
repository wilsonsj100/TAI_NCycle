...
raw <- read.csv(here("IRMS Data/Raw IRMS Data Files","COMPASS_Synoptic_NExpt_MSM_raw1.csv"))
head(raw)
...
#Argon <- c(0.020649991, 0.15188884, 0.029820488, 0.015398439, 0.069320648, 0.146066591, 0.04145506, 0)
...
write.csv(samples, file = here("Processed Data","COMPASS_NExpt_N2Calc_FullOutput_MSM1.csv"))  #this will give you everything 

#write.csv(output, file="output.csv")  #this is if you want the samples, areas, del value, and corrected 29 & 30 N2
write.csv(finaloutput, file = here("Processed Data","COMPASS_NExpt_N2Calc_Output_MSM1.csv"))  #this will give you just the sample names and the corrected 29 & 30
##############
