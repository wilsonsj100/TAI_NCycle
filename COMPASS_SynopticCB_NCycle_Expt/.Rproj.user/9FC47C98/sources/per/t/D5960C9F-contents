...
write.csv(samples, file = here("Processed Data","COMPASS_NExpt_N2Calc_FullOutput_50uL_Loop2.csv"))  #this will give you everything 

#write.csv(output, file="output.csv")  #this is if you want the samples, areas, del value, and corrected 29 & 30 N2
write.csv(finaloutput, file = here("Processed Data","COMPASS_NExpt_N2Calc_Output_50uL_Loop2.csv"))  #this will give you just the sample names and the corrected 29 & 30
########################################################################
