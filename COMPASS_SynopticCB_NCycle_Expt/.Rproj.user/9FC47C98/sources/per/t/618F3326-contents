...
################ I did not analyze the one rerun sample ###############################
#read in raw data 
library(here)

raw <- read.csv(here("IRMS Data/Raw IRMS Data Files","COMPASS_Synoptic_NExpt_GWI_rerun1.csv"))
head(raw)
...
write.csv(samples, file =here("Processed Data", "COMPASS_NExpt_N2Calc_FullOutput_GWIrerun.csv"))  #this will give you everything 

#write.csv(output, file="output.csv")  #this is if you want the samples, areas, del value, and corrected 29 & 30 N2
write.csv(finaloutput, file = here("Processed Data","COMPASS_NExpt_N2Calc_Output_GWIrerun.csv"))  #this will give you just the sample names and the corrected 29 & 30
...
#levels(finaloutput$`Sample Name`) <- c("70cm_Control", "70cm_GraphOx", "100cm_Control", "100cm_GraphOx", "120cm_Control", "120cm_GraphOx", "175cm_Control", "175cm_GraphOx", "250cm_Control",  "250cm_GraphOx", 
# "blank", "Air 5", "Air 10", "Air 20", "Air 30")   
