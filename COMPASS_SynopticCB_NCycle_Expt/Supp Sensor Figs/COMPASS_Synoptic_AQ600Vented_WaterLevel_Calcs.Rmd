...
L1 <- "S:/Biogeochemistry/People/Wilson (Steph)/Compass N Cycle Experiment/Full Incub. Experiment/Manuscript/Supp Sensor Figs"
...
well_elevation <- 
  read.csv("S:/Biogeochemistry/People/Wilson (Steph)/Compass N Cycle Experiment/Full Incub. Experiment/Manuscript/Supp Sensor Figs/well_info/COMPASS_CBSynoptic_AQ600_RTK_Data_WellBases.csv")   %>%
...
well_dimensions <- 
  read.csv("S:/Biogeochemistry/People/Wilson (Steph)/Compass N Cycle Experiment/Full Incub. Experiment/Manuscript/Supp Sensor Figs/well_info/well_dimensions.csv") %>% 
  mutate(Plot = case_when(transect_location == "Upland" ~ "UP", 
                              transect_location == "Transition" ~ "TR", 
                              transect_location == "Wetland" ~ "W"), 
         ground_to_sensor_cm = ring_to_pressure_sensor_cm - (well_top_to_ground_cm - bolt_to_cap_cm)) %>% 
