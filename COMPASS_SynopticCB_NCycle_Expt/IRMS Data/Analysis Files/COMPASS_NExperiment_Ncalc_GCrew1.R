...
raw <- read.csv(here("IRMS Data/Raw IRMS Data Files", "COMPASS_Synoptic_NExpt_GCrew_raw1.csv"))
head(raw)
...
#pull out standards & check order 
...
uLair <- c(5,5,10,10,10,20,20,30,30)
...
#Argon <- c(0.020649991, 0.15188884, 0.029820488, 0.029820488, 0.015398439, 0.069320648, 0.146066591, 0.04145506, 0)
...
#Nox Box - any background nitrate in your samples? You would add that here for dilution
...
#continuing based on 28 as background 
...
write.csv(samples, file =here("Processed Data", "COMPASS_NExpt_N2Calc_FullOutput_GCrew1.csv"))  #this will give you everything 

#write.csv(output, file="output.csv")  #this is if you want the samples, areas, del value, and corrected 29 & 30 N2
write.csv(finaloutput, file = here("Processed Data","COMPASS_NExpt_N2Calc_Output_GCrew1.csv"))  #this will give you just the sample names and the corrected 29 & 30
##################################################
