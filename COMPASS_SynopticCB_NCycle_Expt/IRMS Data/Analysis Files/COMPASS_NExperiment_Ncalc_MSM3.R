...
raw <- read.csv(here("IRMS Data/Raw IRMS Data Files","COMPASS_Synoptic_NExpt_MSM_TR_raw3.csv"))
head(raw)
...
#take out checks & blanks
#STDs <- STDs[-c(6,7), ]
head(STDs)  #you need to check the order of your stds to make sure there was nothing weird 
...
STDs <- STDs[-c(1,2), ] #I already did this above
head(STDs)

uLair <- c(5,10,10,20,20,30,30)
...
#Argon <- c(0.020649991, 0.029820488, 0.015398439, 0.069320648, 0.146066591, 0.04145506, 0)
...
write.csv(samples, file = here("Processed Data","COMPASS_NExpt_N2Calc_FullOutput_MSM3.csv"))  #this will give you everything 

#write.csv(output, file="output.csv")  #this is if you want the samples, areas, del value, and corrected 29 & 30 N2
write.csv(finaloutput, file = here("Processed Data","COMPASS_NExpt_N2Calc_Output_MSM3.csv"))  #this will give you just the sample names and the corrected 29 & 30
##############
