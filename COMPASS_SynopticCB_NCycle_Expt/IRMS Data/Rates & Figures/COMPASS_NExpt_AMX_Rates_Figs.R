...
pdf(here("IRMS Data/Rates & Figures" ,"MSM_Raw_29N2N_overtime.pdf"), width=12,height=4)
MSMRaw
dev.off()
...
pdf(here("IRMS Data/Rates & Figures" ,"GWI_Raw_29N2N_overtime.pdf"), width=12,height=4)
GWIRaw
dev.off()
...
pdf(here("IRMS Data/Rates & Figures" ,"SWH_Raw_29N2N_overtime.pdf"), width=12,height=4)
SWHRaw
dev.off()
...
pdf(here("IRMS Data/Rates & Figures" ,"Raw_29N2N_overtime.pdf"), width=10,height=12)
N2_29RatesRaw
dev.off()
...
write.csv(Rates, file=here("IRMS Data/Rates & Figures" ,"AMX_Rates_RCalc.csv"))
...
write.csv(RatesAvg, file=here("IRMS Data/Rates & Figures" ,"Avg_AMX_Rates_RCalc.csv"))
