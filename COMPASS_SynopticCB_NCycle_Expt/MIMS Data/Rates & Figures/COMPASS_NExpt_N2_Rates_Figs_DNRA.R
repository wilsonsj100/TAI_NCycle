...
compass_coolors1 <- c("#20063B", "#9255D4", "#419973")
...
pdf(here("MIMS Data/Rates & Figures","GCrew_Raw_NH4_overtime.pdf"), width=12,height=4)
GcrewRaw
dev.off()
...
pdf(here("MIMS Data/Rates & Figures","MSM_Raw_NH4_overtime.pdf"), width=12,height=4)
MSMRaw
dev.off()
...
pdf(here("MIMS Data/Rates & Figures","GWI_Raw_NH4_overtime.pdf"), width=12,height=4)
GWIRaw
dev.off()
...
pdf(here("MIMS Data/Rates & Figures","SWH_Raw_NH4_overtime.pdf"), width=12,height=4)
SWHRaw
dev.off()
...
pdf(here("MIMS Data/Rates & Figures","Raw_NH4-N_overtime.pdf"), width=10,height=12)
N2RatesRaw
dev.off()
...
write.csv(Rates, file=here("MIMS Data/Rates & Figures","DNRA_Rates_RCalc.csv"))
...
write.csv(RatesAvg, file=here("MIMS Data/Rates & Figures","Avg_DNRA_Rates_RCalc.csv"))
...
Gavg <- ggplot(data=G2, aes(x=Zone, y=mean, fill=Zone)) +
  ...
  labs(y=expression("nmoles NH "[4]*"-N wet g"^-1*" h"^-1)) +
  xlab(" ") + 
  ggtitle("(a) GCReW") +
...
pdf(here("MIMS Data/Rates & Figures","Avg_DNRA_NH4_Rates1.pdf"), width=8,height=8)
All_Avg
dev.off()

ggsave(plot = All_Avg, here("MIMS Data/Rates & Figures","DNRA_rates.png"), h = 8, w = 8, type = "cairo-png")
...
pdf(here("MIMS Data/Rates & Figures","Avg_DNRA_NH4_Rates2.pdf"), width=8,height=8)
All_Avg1
dev.off()
